...
** IMPORT & CLEAN DATA **
import excel using "input/skills.xlsx", sheet("Table 6.2") ///
 cellra(A2) first case(lower) clear

drop if mi(b) | typicaleduc == "—"
keep b typicaleduc employment2023
rename (b t e) (occ_soc educ_req tot_emp)
